...
// Generiert am: 2025-10-12T17:55:26.412Z
...
export const AUTO_GENERATED_SCHEMA_DEFINITIONS: SchemaDefinitions = {
  "EinkaufsItem": {
    "tableName": "einkaufsitems",
    "interfaceName": "EinkaufsItem",
    "columns": [
      {
        "name": "db_id",
        "type": "UUID",
      ...
      },
      {
        ...
        "nullable": false,
        "primary": false,
        "description": "artikelName property",
        "tsType": "string"
      },
      {
        "name": "menge",
      ...
      },
      {
        ...
        "nullable": true,
        "primary": false,
        "description": "lieferant property",
        "tsType": "string"
      },
      {
        "name": "preis",
      ...
      },
      {
        ...
        "nullable": true,
        "primary": false,
        "description": "bestelldatum property",
        "tsType": "Date"
      },
      {
        "name": "lieferdatum",
        ...
        "nullable": true,
        "primary": false,
        "description": "lieferdatum property",
        "tsType": "Date"
      },
      {
        "name": "status",
  ...
  "InventurItem": {
    "tableName": "inventuritems",
    "interfaceName": "InventurItem",
    "columns": [
      {
        "name": "db_id",
        "type": "UUID",
      ...
      },
      {
        ...
        "nullable": false,
        "primary": false,
        "description": "kategorie property",
        "tsType": "string"
      },
      {
        "name": "soll_bestand",
        ...
        "nullable": true,
        "primary": false,
        "description": "sollBestand property",
        "tsType": "number"
      },
      {
        "name": "ist_bestand",
        ...
        "nullable": true,
        "primary": false,
        "description": "istBestand property",
        "tsType": "number"
      },
      {
        "name": "einheit",
      ...
      },
      {
        ...
        "nullable": true,
        "primary": false,
        "description": "inventurDatum property",
        "tsType": "Date"
      },
      {
        "name": "differenz",
        ...
        "nullable": true,
        "primary": false,
        "description": "differenz property",
        "tsType": "number"
      },
      {
        "name": "bemerkung",
        ...
        "nullable": true,
        "primary": false,
        "description": "bemerkung property",
        "tsType": "string"
      },
      {
        "name": "is_dirty",
...
-- Generiert am: 2025-10-12T17:55:26.379Z
-- Automatische Schema-Generierung mit ts-morph
